...
@RequestMapping		/* Add a new Tournament to Database */
	...
	public void addTournament(@RequestBody Tourneys tourney) {
		...
		tourneysDAO.createATourney(tourney.getTourneyName(), 
								   tourney.getTourneyDesc(), 
								   tourney.getTourneyHost(),
								   tourney.getStartDate(), 
								   tourney.getEndDate(),
								   tourney.isActive(),
								   tourney.isOpenForReg(),
								   tourney.getMaxNumOfParticipants(),
								   tourney.getNumOfParticipants());
		}
...
@RequestMapping		/* Get all users by tounreyID */
...
@RequestMapping		/* Update user tourney status */
	(path = "/status/{status}/{username}/{tourneyID}", method = RequestMethod.PUT)
...
@RequestMapping		/* Get user name by tourneyId */
...
@RequestMapping		/* Update users matches */
...
@RequestMapping		/* Get all matches in UM by tourneyId */
	(path = "/tourneysDAO/{users}/{tourneyID}/", method = RequestMethod.GET)
